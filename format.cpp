...
ostream& _ostrformat( ostream& out, const string& format, va_list ap );
int _istrscanf( istream& ins, const string& format, va_list ap );
...
ostream& streamformat( ostream& out, const char* format , ... ) {
	va_list ap;
	va_start( ap, format );
	string s( format );
	_ostrformat( out, s, ap );
...
ostream& streamformat( ostream& out, const string& format , ... ) {
	va_list ap;
	va_start( ap, format );
	_ostrformat( out, format, ap );
	va_end( ap );
...
ostream& _ostrformat( ostream& out, const string& format, va_list ap ) {
	...
	ostringstream old;
	string::const_iterator fPtr;
	string::const_iterator uPtr;
			...
			*/
			switch ( *fPtr ) {
				...
				case 'B':
					out.setf( ios::uppercase );
				case 'b':
					out << ( 0 != va_arg( ap, int ) ? "true" : "false" );
					break;
				case '%':
					out << '%';
					break;
...
int _istrscanf( istream& ins, const string& format, va_list ap ) {
	...
	string::const_iterator fPtr = format.begin();
	bool breakout = false;
